...
const Login = () => {
    ...
    const handleLogin = async (e) => {
        ...
        try {
            ...
            // Store JWT for header-based auth as well
            ...
            if (res.data.role === "teacher") {
                ...
                const ORION_LINES = [
                    "Orion‑X: Chart your course. Conquer your concepts.",
                    "Aim higher. Orion‑X turns effort into mastery.",
                    "Orion‑X: Every lesson is a new constellation.",
                    "Ignite curiosity. Navigate with Orion‑X.",
                    "Learn brighter, faster, smarter with Orion‑X.",
                    "Orion‑X: Your path to mastery is mapped.",
                    "Steady steps, stellar results. Orion‑X.",
                    "From question to clarity—guided by Orion‑X.",
                    "Level up today. Orion‑X has your back.",
                    "Explore, practice, excel—Orion‑X style."
                ];
                const pick = ORION_LINES[Math.floor(Math.random() * ORION_LINES.length)];
                toast.success(pick);
            ...
            if (!err.response) {
                ...
                toast.error(err.response?.data?.detail || "Invalid Email, Password, or Role selection");
            }
        } finally {
            setLoading(false);
        }
